...
public class APPOPSINFOAdapter extends BaseAdapter {
    ...
    public APPOPSINFOAdapter(ArrayList<String> list, Context context, ArrayList<Boolean> checkboxs, ArrayList<Boolean> switbs, String pkgname, int mode) {
        this.list = list;
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if(b){
                    switch (mode){
                        case 0:
                        case 1:
                            multiFunc.runAppopsCMD(context,pkgname,pkgcate,4,"开启组件成功","开启组件失败");
                            break;
                        case 2:
                            multiFunc.runAppopsCMD(context,pkgname,pkgcate,3,"开启权限成功","开启权限失败");
                            break;
                    }
                }else{
                    switch (mode){
                        case 0:
                        case 1:
                            multiFunc.runAppopsCMD(context,pkgname,pkgcate,1,"关闭组件成功","关闭组件失败");
                            break;
                        case 2:
                            multiFunc.runAppopsCMD(context,pkgname,pkgcate,0,"关闭权限成功","关闭权限失败");
                            break;
                    }
                }
            }
