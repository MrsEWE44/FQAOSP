...
public class otherToolsActivity extends AppCompatActivity {
    ...
    private Button otabt1,otabt2,otabt3;
    int otrrasp1_index=0,otrrasp2_index=0;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (itemId){
            case 0:
                showInfoMsg(this,"帮助信息","该页面是小工具的合集，有需要root或adb授权的功能,红色是必须root权限才能使用的,黄色则是可以通过adb权限使用。\r\n" +
